...
if __name__ == '__main__':
    ...
    while True:
        ...
        search_list = search_results_list(search_string, search_list)  # функция search_results_list нужна
        print('\n'.join(search_list))
        # print('Всего: ', search_results_count(search_string, search_list))
        print('Всего: ', len(search_list))  # функция search_results_count оказалась не нужна
